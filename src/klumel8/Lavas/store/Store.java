...
public class Store {
    ...
    public static void setInitialItems(){
        ...
        System.out.println("pouch cap"+pouchCapacity());
        if(pouchCapacity() == 0 && !Store.magicImbue){
            System.out.println("No pouches found, setting earth talisman to 1");
            Store.earthTalismanAmount = 1;
        }
    }
