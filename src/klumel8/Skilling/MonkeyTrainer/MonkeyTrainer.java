package klumel8.Skilling.MonkeyTrainer;

import com.google.common.eventbus.Subscribe;
import klumel8.KlumAPI.Framework.Branch;
import klumel8.KlumAPI.Framework.Leaf;
import klumel8.Skilling.MonkeyTrainer.Branches.BankHandler.BankHandler;
import klumel8.Skilling.MonkeyTrainer.Branches.BankHandler.Leaves.*;
import klumel8.Skilling.MonkeyTrainer.Branches.BoneHandler.BoneHandler;
import klumel8.Skilling.MonkeyTrainer.Branches.BoneHandler.Leaves.DistributeBones;
import klumel8.Skilling.MonkeyTrainer.Branches.BoneHandler.Leaves.PickUpBones;
import klumel8.Skilling.MonkeyTrainer.Branches.GoToSpot.Leaves.CloseBank;
import klumel8.Skilling.MonkeyTrainer.Branches.GoToSpot.Leaves.TeleToDungeon;
import klumel8.Skilling.MonkeyTrainer.Branches.StatsUpkeep.Leaves.*;
import klumel8.Skilling.MonkeyTrainer.Branches.StatsUpkeep.StatsUpkeep;
import klumel8.Skilling.MonkeyTrainer.Branches.MonkeyHandler.Leaves.*;
import klumel8.Skilling.MonkeyTrainer.Branches.MonkeyHandler.MonkeyHandler;
import klumel8.Skilling.MonkeyTrainer.Branches.GoToSpot.Leaves.Walker;
import klumel8.Skilling.MonkeyTrainer.Branches.GoToSpot.GoToSpot;
import kotlin.Pair;
...
@ScriptConfiguration.List(
        {
                ...
                @ScriptConfiguration(
                        ...
                        defaultValue = "Shark",
                        allowedValues = {"Shark","Cooked karambwan","Manta ray","Anglerfish","Tuna","Lobster","Swordfish"},
                        optionType = OptionType.STRING
                )
        }
)
...
//        Condition.sleep(500);
        ...
        if(Shared.weaponName.equalsIgnoreCase("Smoke burst")){
            Shared.keepItems = new String[]{"Camelot teleport", "Ape atoll teleport", "Air rune", "Fire rune", "Chaos rune", "Death rune", "Rune pouch"};
            Shared.spell = Magic.AncientSpell.SMOKE_BURST;
        }else if(Shared.weaponName.equalsIgnoreCase("Ice burst")){
            Shared.keepItems = new String[]{"Camelot teleport", "Ape atoll teleport", "Water rune", "Chaos rune", "Death rune", "Rune pouch"};
            Shared.spell = Magic.AncientSpell.ICE_BURST;
        }else if(Shared.weaponName.equalsIgnoreCase("Smoke barrage")){
            Shared.keepItems = new String[]{"Camelot teleport", "Ape atoll teleport", "Air rune", "Fire rune", "Blood rune", "Death rune", "Rune pouch"};
            Shared.spell = Magic.AncientSpell.SMOKE_BARRAGE;
        }else if(Shared.weaponName.equalsIgnoreCase("Ice barrage")){
            Shared.keepItems = new String[]{"Camelot teleport", "Ape atoll teleport", "Water rune", "Blood rune", "Death rune", "Rune pouch"};
